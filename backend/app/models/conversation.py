...
class Conversation(Base):
    ...
    initiator_username = Column(String, nullable=False)
    ...
    def __repr__(self):
        return f"Conversation({self.conv_id}, initiator={self.initiator_username}, recipient={self.recipient_username}, is_anonymous={self.is_anonymous}, created_at={self.created_at}), initiator_opened-{self.initiator_opened}, recipient_opened={self.recipient_opened})"
